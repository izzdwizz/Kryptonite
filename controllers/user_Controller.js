...
const userController = {
	register: asyncHandler(async (req, res) => {
		...
		try {
			...
			await sendEmail(
				email,
				'Kryptonite Email Confirmation',
				`Please confirm your email by clicking the following link: ${confirmUrl} . The link expires in One hour`
			);
